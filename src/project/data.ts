...
// 프로젝트 데이터는 여기에서 한 번만 초기화됩니다.
// (메인/프로젝트 페이지 모두 이 모듈을 공유해서 "저장된 것"을 자동으로 로드합니다.)
PrCategory.data = [];

PrCategory.$("unity", "게임 개발", "img/unity.png").Projects(
    Pj.$("ignotus", "IGNOTUS")
        .Platform("Mobile")
        ...
        .Video("https://youtu.be/lFor-bfjdXk"),
    ...
    Pj.$("albedo", "Albedo")
        ...
        .Github("https://github.com/sunrinton2025/amazing_something")
    ...
    Pj.$("isekai-button", "버튼을 눌렀더니 판타지 게임속 주인공이 되어버린 건에 대하여")
        ...
        .Github("https://github.com/counterSpellkuku/something"),
    Pj.$("deliver-homez", "구해줘 홈즈 김배달의 우당탕탕 대모험")
        ...
        .Download("https://github.com/ttalbaeproject/ttalbae/releases/download/1.1/ttalbae.zip"),
    Pj.$("echo", "ECHO")
        .Platform("PC")
    ...
    Pj.$("eucliwood", "유클리우드 Edge")
        ...
        .Github("https://github.com/minyee2913/eucliwood"),
    Pj.$("farmer-happy-life", "파머의 해피 라이프")
        ...
        .Github("https://github.com/minyee2913/unity-project1"),
);

PrCategory.$("minecraft", "마인크래프트 개발", "img/minecraft.png").Projects(
    Pj.$("luminous", "Luminous RPG")
        ...
        .Video("https://youtu.be/fv8noVWhBAk"),
    ...
    Pj.$("video-particle", "Video Particle")
        ...
        .Description("영상 파일 데이터를 추출해서 마인크래프트 내 파티클로 영상을 그대로 구현하고 재생하는 외부 프로그램."),
...
export const projectCategories = PrCategory.data;
